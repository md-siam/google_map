...
class _MyAppState extends State<MyApp> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.only(top: 470, bottom: 30),
            child: ListView(
  ...
  List<Technician> getTechies() {
    ...
    for (int i = 0; i < 10; i++) {
      AssetImage profilePic = new AssetImage("lib/assets/profile.jpg");
      Technician myTechy = new Technician("Md. Siam", "01755997775",
          "East Badda", 529.3, 4, "Available", profilePic, "App Developer");
      techies.add(myTechy);
    }
    return techies;
  }
